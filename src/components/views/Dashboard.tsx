    ...
    <div className="h-full grid gap-6 md:grid-cols-3 md:grid-rows-1">
      ...
      >
        <div className="flex flex-col gap-3 h-full justify-start">
          <button className="group relative overflow-hidden rounded-xl border border-white/10 bg-gradient-to-r from-blue-600/10 to-blue-500/5 p-5 text-left transition-all duration-200 hover:scale-[1.02] hover:shadow-lg hover:border-blue-400/30 flex-1 min-h-[70px]">
          ...
          <button className="group relative overflow-hidden rounded-xl border border-white/10 bg-gradient-to-r from-purple-600/10 to-purple-500/5 p-5 text-left transition-all duration-200 hover:scale-[1.02] hover:shadow-lg hover:border-purple-400/30 flex-1 min-h-[70px]">
            <div className="flex items-center gap-4">
          ...
          <button className="group relative overflow-hidden rounded-xl border border-white/10 bg-gradient-to-r from-emerald-600/10 to-emerald-500/5 p-5 text-left transition-all duration-200 hover:scale-[1.02] hover:shadow-lg hover:border-emerald-400/30 flex-1 min-h-[70px]">
            <div className="flex items-center gap-4">
